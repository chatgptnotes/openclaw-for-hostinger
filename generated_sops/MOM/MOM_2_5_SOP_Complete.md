# Allergy Documentation (MOM.2.5)

**SOP ID:** SOP-MOM-2.5-108
**Department:** Pharmacy Department / Clinical Departments
**Type:** Medication Management Protocol
**Version:** 1.0
**Effective Date:** 2026-02-06
**Next Review:** 2027-02-06
**NABH Standard:** MOM.2.5 - Allergy documentation

---

## 1. Purpose and Scope

**Objective:** To establish comprehensive allergy documentation standards ensuring accurate, timely, and legally compliant record-keeping.
...
### 5.1 Overview
Hope & Ayushman Hospitals follows standardized procedures for allergy documentation ensuring consistency, quality, and compliance with regulatory requirements.
