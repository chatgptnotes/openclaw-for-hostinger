# Patient Identification And Registration (AAC.2.1)

**SOP ID:** SOP-AAC-2.1-006
**Department:** Admissions / Patient Registration
**Type:** Clinical Protocol
**Version:** 1.0
**Effective Date:** 2026-02-06
**Next Review:** 2027-02-06
**NABH Standard:** AAC.2.1 - Patient identification and registration

---

## 1. Purpose and Scope

**Objective:** To establish comprehensive procedures for patient identification and registration ensuring quality, safety, and compliance with NABH standards.
...
Hope & Ayushman Hospitals is committed to implementing comprehensive patient identification and registration procedures meeting NABH standards and ensuring optimal patient outcomes.
...
### 5.1 Overview
Hope & Ayushman Hospitals follows standardized procedures for patient identification and registration ensuring consistency, quality, and compliance with regulatory requirements.
...
**NABH Standard Reference:** AAC.2 - Admission Process
...
|------|------|-------------|------|-----------|
| Prepared By | | Admissions Manager | | |
