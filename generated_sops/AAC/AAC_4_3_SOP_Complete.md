# Patient/Family Participation In Planning (AAC.4.3)

**SOP ID:** SOP-AAC-4.3-028
**Department:** Case Management
**Type:** Clinical Protocol
**Version:** 1.0
**Effective Date:** 2026-02-06
**Next Review:** 2027-02-06
**NABH Standard:** AAC.4.3 - Patient/family participation in planning

---

## 1. Purpose and Scope

**Objective:** To establish comprehensive procedures for patient/family participation in planning ensuring quality, safety, and compliance with NABH standards.
...
Hope & Ayushman Hospitals is committed to implementing comprehensive patient/family participation in planning procedures meeting NABH standards and ensuring optimal patient outcomes.
...
### 5.1 Overview
Hope & Ayushman Hospitals follows standardized procedures for patient/family participation in planning ensuring consistency, quality, and compliance with regulatory requirements.
...
**NABH Standard Reference:** AAC.4 - Care Planning
...
|------|------|-------------|------|-----------|
| Prepared By | | Case Management Coordinator | | |
