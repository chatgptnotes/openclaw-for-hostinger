# Resuscitation Status Documentation (COP.2.5)

**SOP ID:** SOP-COP-2.5-052
**Department:** Critical Care / Clinical Departments
**Type:** Patient Care Protocol
**Version:** 1.0
**Effective Date:** 2026-02-06
**Next Review:** 2027-02-06
**NABH Standard:** COP.2.5 - Resuscitation status documentation

---

## 1. Purpose and Scope

**Objective:** To establish comprehensive resuscitation status documentation standards ensuring accurate, timely, and legally compliant record-keeping.
...
### 5.1 Overview
Hope & Ayushman Hospitals follows standardized procedures for resuscitation status documentation ensuring consistency, quality, and compliance with regulatory requirements.
