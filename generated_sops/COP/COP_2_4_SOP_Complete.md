# Family Communication For High-Risk (COP.2.4)

**SOP ID:** SOP-COP-2.4-051
**Department:** Critical Care / Clinical Departments
**Type:** Patient Care Protocol
**Version:** 1.0
**Effective Date:** 2026-02-06
**Next Review:** 2027-02-06
**NABH Standard:** COP.2.4 - Family communication for high-risk

---

## 1. Purpose and Scope

**Objective:** To establish comprehensive procedures for family communication for high-risk ensuring quality, safety, and compliance with NABH standards.
...
Hope & Ayushman Hospitals is committed to implementing comprehensive family communication for high-risk procedures meeting NABH standards and ensuring optimal patient outcomes.
...
### 5.1 Overview
Hope & Ayushman Hospitals follows standardized procedures for family communication for high-risk ensuring consistency, quality, and compliance with regulatory requirements.
...
|------|------|-------------|------|-----------|
| Prepared By | | Critical Care Manager | | |
