# Nutritional Assessment Protocols (COP.3.1)

**SOP ID:** SOP-COP-3.1-058
**Department:** Nutrition Services / Dietetics
**Type:** Patient Care Protocol
**Version:** 1.0
**Effective Date:** 2026-02-06
**Next Review:** 2027-02-06
**NABH Standard:** COP.3.1 - Nutritional assessment protocols

---

## 1. Purpose and Scope

**Objective:** To implement systematic nutritional assessment protocols procedures ensuring comprehensive evaluation and appropriate care planning for all patients.
...
### 5.1 Overview
Hope & Ayushman Hospitals follows standardized procedures for nutritional assessment protocols ensuring consistency, quality, and compliance with regulatory requirements.
...
### Initial Training
- Patient Care Protocol orientation: 4 hours
...
**NABH Standard Reference:** COP.3 - Nutrition and Food Service
...
|------|------|-------------|------|-----------|
| Prepared By | | Nutrition Services Manager | | |
