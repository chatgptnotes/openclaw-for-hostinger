# Hand Hygiene Documentation (HIC.2.6)

**SOP ID:** SOP-HIC-2.6-186
**Department:** All Clinical Departments
**Type:** Infection Control Protocol
**Version:** 1.0
**Effective Date:** 2026-02-06
**Next Review:** 2027-02-06
**NABH Standard:** HIC.2.6 - Hand hygiene documentation

---

## 1. Purpose and Scope

**Objective:** To establish comprehensive hand hygiene documentation standards ensuring accurate, timely, and legally compliant record-keeping.
...
### 5.1 Overview
Hope & Ayushman Hospitals follows standardized procedures for hand hygiene documentation ensuring consistency, quality, and compliance with regulatory requirements.
