# Isolation Documentation (HIC.3.8)

**SOP ID:** SOP-HIC-3.8-193
**Department:** Infection Control / Clinical Departments
**Type:** Infection Control Protocol
**Version:** 1.0
**Effective Date:** 2026-02-06
**Next Review:** 2027-02-06
**NABH Standard:** HIC.3.8 - Isolation documentation

---

## 1. Purpose and Scope

**Objective:** To establish comprehensive isolation documentation standards ensuring accurate, timely, and legally compliant record-keeping.
...
### 5.1 Overview
Hope & Ayushman Hospitals follows standardized procedures for isolation documentation ensuring consistency, quality, and compliance with regulatory requirements.
