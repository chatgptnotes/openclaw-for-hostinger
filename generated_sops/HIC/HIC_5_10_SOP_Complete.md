# Cleaning Documentation (HIC.5.10)

**SOP ID:** SOP-HIC-5.10-213
**Department:** Housekeeping / Environmental Services
**Type:** Infection Control Protocol
**Version:** 1.0
**Effective Date:** 2026-02-06
**Next Review:** 2027-02-06
**NABH Standard:** HIC.5.10 - Cleaning documentation

---

## 1. Purpose and Scope

**Objective:** To establish comprehensive cleaning documentation standards ensuring accurate, timely, and legally compliant record-keeping.
...
### 5.1 Overview
Hope & Ayushman Hospitals follows standardized procedures for cleaning documentation ensuring consistency, quality, and compliance with regulatory requirements.
