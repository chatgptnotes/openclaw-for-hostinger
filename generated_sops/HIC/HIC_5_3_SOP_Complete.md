# Disinfectant Selection Protocols (HIC.5.3)

**SOP ID:** SOP-HIC-5.3-206
**Department:** Housekeeping / Environmental Services
**Type:** Infection Control Protocol
**Version:** 1.0
**Effective Date:** 2026-02-06
**Next Review:** 2027-02-06
**NABH Standard:** HIC.5.3 - Disinfectant selection protocols

---

## 1. Purpose and Scope

**Objective:** To establish comprehensive procedures for disinfectant selection protocols ensuring quality, safety, and compliance with NABH standards.
...
Hope & Ayushman Hospitals is committed to implementing comprehensive disinfectant selection protocols procedures meeting NABH standards and ensuring optimal patient outcomes.
...
### 5.1 Overview
Hope & Ayushman Hospitals follows standardized procedures for disinfectant selection protocols ensuring consistency, quality, and compliance with regulatory requirements.
...
**NABH Standard Reference:** HIC.5 - Environmental Cleaning
...
|------|------|-------------|------|-----------|
| Prepared By | | Environmental Services Manager | | |
