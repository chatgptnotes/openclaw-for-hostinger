# Utility Documentation (FMS.3.12)

**SOP ID:** SOP-FMS-3.12-326
**Department:** Engineering Services / Facility Management
**Type:** Facility Management Protocol
**Version:** 1.0
**Effective Date:** 2026-02-06
**Next Review:** 2027-02-06
**NABH Standard:** FMS.3.12 - Utility documentation

---

## 1. Purpose and Scope

**Objective:** To establish comprehensive utility documentation standards ensuring accurate, timely, and legally compliant record-keeping.
...
### 5.1 Overview
Hope & Ayushman Hospitals follows standardized procedures for utility documentation ensuring consistency, quality, and compliance with regulatory requirements.
