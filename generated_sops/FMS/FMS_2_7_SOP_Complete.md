# Equipment Documentation (FMS.2.7)

**SOP ID:** SOP-FMS-2.7-307
**Department:** Biomedical Engineering / Facility Management
**Type:** Facility Management Protocol
**Version:** 1.0
**Effective Date:** 2026-02-06
**Next Review:** 2027-02-06
**NABH Standard:** FMS.2.7 - Equipment documentation

---

## 1. Purpose and Scope

**Objective:** To establish comprehensive equipment documentation standards ensuring accurate, timely, and legally compliant record-keeping.
...
### 5.1 Overview
Hope & Ayushman Hospitals follows standardized procedures for equipment documentation ensuring consistency, quality, and compliance with regulatory requirements.
